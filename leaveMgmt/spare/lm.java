...
import java.sql.*;
import java.io.*;
class lm extends Frame implements ActionListener
{
 Statement stmt;
 Connection con;
 int tempid,cl,sl,el;
 ...
 class apply extends Dialog implements ActionListener
 {
  ...
  public void applyleave()
  {
   ...
   String temptype;
   ResultSet rs;
   temptypeindex=applyc1.getSelectedIndex();
   ...
   {
    try{
    stmt.executeUpdate("update staff set seen=1 where id='"+tempid+"'");
