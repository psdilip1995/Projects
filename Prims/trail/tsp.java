...
{
 int i=0,j=0,k=1,t,tn,n,distance[][],x=30,y=10,result[];
...
System.out.print(" "+result[g]);
 ...
 class can4 extends Canvas
 {
  ...
  public void paint(Graphics g)
  {
   ...
   int tn=(n-2)/2;
   int tn1=(n-2)%2;
   g.drawOval(x,y,580,580);
   g.setColor(Color.white);
   g.fillOval(x-25,270,50,50);
   g.fillOval(x+555,270,50,50);
   int up=580/tn;
   int down=up;
   if(tn1==1)
	down=up-1;
   int upxy[][]=new int[up][2];
   int downxy[][]=new int[down][2];
