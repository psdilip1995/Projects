...
class maptsp extends Frame implements ActionListener,MouseListener,MouseMotionListener
{
 ...
 class showmsg extends Dialog implements ActionListener
 {
  Label shl;
  Button shb;
  showmsg(Frame f)
  {
   super(f,"Image Saved",true);
   shl=new Label("Image saved on desktop");
   shb=new Button("ok");
